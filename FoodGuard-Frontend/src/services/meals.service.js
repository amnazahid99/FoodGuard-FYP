...
export const mealsService = {
  ...
  generateMealPlan: (condition) =>
    api.post('/meals/meal-plan', typeof condition === 'object' ? condition : { condition }).then(r => r.data?.plan || null),
  ...
  chatWithChef: (payload)  => api.post('/meals/chat-with-chef', payload).then(r => r.data || {}),
};
