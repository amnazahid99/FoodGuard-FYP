  ...
  useEffect(() => {
    ...
    for (let i = 0; i < 100; i++) {
      particles.push({
        ...
        opacity: isDark ? (Math.random() * 0.5 + 0.3) : (Math.random() * 0.2 + 0.05),
      });
    }
...
if (isDark) {
            ...
            ctx.fillStyle = 'rgba(250, 252, 255, 0.08)';
          }
        ...
        particles.forEach((particle) => {
          ...
          if (isDark) {
            ...
            ctx.fillStyle = `rgba(196, 151, 56, ${particle.opacity})`;
            ctx.shadowColor = 'rgba(196, 151, 56, 0.15)';
          }
          ctx.shadowBlur = 6;
          ctx.fill();
          ctx.shadowBlur = 0;
